...
function sendmail($tomail, $totmailname , $subject, $message)
{
	...
	$smtpport 	= 465;
	$mailsender = "E Book Gallery";
	$companyname= "E Book Gallery";
	$facebook = "https://www.facebook.com";
	$twitter = "https://www.twitter.com";
	$youtube = "https://www.youtube.com";
	$linkedin = "https://www.linkedin.com";
	$companyaddress  = "E Book Gallery, Ahmedabad, India | Email us: ebookgallery@gmail.com";
	$contactno = "+91-7283951617";
	$url = "www.ebookgallery.com";
